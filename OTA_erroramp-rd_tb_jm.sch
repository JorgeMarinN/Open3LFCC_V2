...
let id13  = @m.x1.xm13.msky130_fd_pr__nfet_g5v0d10v5[id]
...
C {devices/isource.sym} 1280 -70 2 0 {name=I0 value=7u
}
...
C {/foss/designs/Open3LFCC_V2/OTA_erroramp_jm_rd.sym} 1180 -320 0 0 {name=x1}
