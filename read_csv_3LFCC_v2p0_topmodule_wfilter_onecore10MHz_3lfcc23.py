...
df=pd.read_fwf('3LFCC_v1p5_topmodule_wfilter_onecore10MHz_3lfcc23.txt')
df.to_csv('3LFCC_v1p5_topmodule_wfilter_onecore10MHz_3lfcc23.csv', index=False)
data = pd.read_csv("3LFCC_v1p5_topmodule_wfilter_onecore10MHz_3lfcc23.csv").values
