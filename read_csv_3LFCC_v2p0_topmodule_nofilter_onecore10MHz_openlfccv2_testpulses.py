...
df=pd.read_fwf('3LFCC_v1p5_topmodule_nofil_tp_onecore10MHz_open3lfccv2.txt')
df.to_csv('3LFCC_v1p5_topmodule_nofil_tp_onecore10MHz_open3lfccv2.csv', index=False)
data = pd.read_csv("3LFCC_v1p5_topmodule_nofil_tp_onecore10MHz_open3lfccv2.csv").values
