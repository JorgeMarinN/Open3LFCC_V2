...
N 4090 -3760 4190 -3760 { lab=#net3}
N 4090 -3760 4090 -3720 { lab=#net3}
...
N 4230 -3610 4230 -3500 {
lab=pos}
N 4230 -3710 4230 -3670 {
lab=ldo_out}
N 4230 -3440 4230 -3410 {
lab=GND}
C {bgr2.sym} 2150 -2100 0 0 {name=xb2}
C {Error_Amp.sym} 3030 -2340 0 0 {name=xy1}
...
*Load_Reg_switches --> commented from before
...
C {devices/res.sym} 4230 -3640 0 0 {name=RD2
value=7e3
footprint=1206
device=resistor
m=1}
C {devices/res.sym} 4230 -3470 0 0 {name=RD1
value=3e3
footprint=1206
device=resistor
m=1}
