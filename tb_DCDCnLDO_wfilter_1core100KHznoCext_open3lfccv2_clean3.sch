...
N 380 -560 380 -530 {
lab=V_CFBOT}
N 1180 -2010 1180 -1940 {
lab=out}
N 800 -1980 840 -1980 {
lab=pos}
N 800 -1900 840 -1900 {
lab=neg}
N 1080 -2120 1120 -2120 {
lab=GND}
N 1100 -1760 1100 -1720 {
lab=vb}
...
.save v(D1) v(D2) v(D1_N) v(D2_N) v(VOUT_CORE) v(ldo_out) v(vh) i(v3) i(v10) i(v11) v(v_cftop,v_cfbot) v(D1,v_cftop) v(D2,vout_core) v(D2_N,v_cfbot) v(D1_Nv,VSS) v(v_out_ls1) v(v_out_ls2) v(d2_n,v_cfbot) v(D1_s) v(D2_s) v(D2_N_s) v(D1_N_s) v(V_res) i(v9) v(neg)
...
C {devices/gnd.sym} 1120 -2120 0 0 {name=l60 lab=GND}
C {/foss/designs/Open3LFCC_V2/OTA_erroramp_jm.sym} 1000 -1940 0 0 {name=x6}
C {devices/lab_pin.sym} 800 -1980 0 0 {name=l66 sig_type=std_logic lab=pos}
C {devices/lab_pin.sym} 800 -1900 0 0 {name=l67 sig_type=std_logic lab=neg}
C {devices/lab_pin.sym} 1100 -1720 0 0 {name=l68 sig_type=std_logic lab=vb}
C {devices/lab_wire.sym} 940 -2120 0 1 {name=l59 sig_type=std_logic lab=VOUT_CORE}
C {devices/lab_pin.sym} 1180 -2010 0 1 {name=l61 sig_type=std_logic lab=out}
