...
N 1500 -1170 1500 -1150 { lab=#net3}
N 1500 -1240 1500 -1230 { lab=inp}
N 1400 -1160 1500 -1160 { lab=#net3}
...
N 2580 -1140 2580 -1070 { lab=mir}
N 1960 -1260 1990 -1260 { lab=bg_out}
N 1940 -1260 1960 -1260 { lab=bg_out}
N 2890 -1260 2920 -1260 { lab=avdd}
N 2920 -1300 2920 -1260 { lab=avdd}
N 2890 -1300 2920 -1300 { lab=avdd}
N 2810 -1260 2850 -1260 { lab=mir}
N 2890 -1230 2890 -1170 { lab=iref}
N 2580 -1010 2580 -970 {
lab=agnd}
N 1890 -1370 2230 -1370 {
lab=avdd}
N 2230 -1370 2230 -1320 {
lab=avdd}
N 2080 -1180 2130 -1180 {
lab=inn}
N 2080 -1100 2130 -1100 {
lab=inp}
N 1650 -940 1720 -940 {
lab=agnd}
N 2470 -1140 2580 -1140 {
lab=mir}
N 2370 -1320 2410 -1320 {
lab=agnd}
N 2230 -1370 2890 -1370 {
lab=avdd}
N 2890 -1370 2890 -1290 {
lab=avdd}
N 3170 -1260 3200 -1260 { lab=avdd}
N 3200 -1300 3200 -1260 { lab=avdd}
N 3170 -1300 3200 -1300 { lab=avdd}
N 3090 -1260 3130 -1260 { lab=mir}
N 3170 -1230 3170 -1170 { lab=iref_int}
N 2890 -1370 3170 -1370 {
lab=avdd}
N 3170 -1370 3170 -1290 {
lab=avdd}
N 2390 -960 2390 -930 {
lab=iref_int}
...
C {devices/lab_pin.sym} 2080 -1180 0 0 {name=l13 sig_type=std_logic lab=inn}
C {devices/lab_pin.sym} 2080 -1100 0 0 {name=l18 sig_type=std_logic lab=inp}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 2580 -1040 0 0 {name=C1 model=cap_mim_m3_1 W=16 L=16 MF=1 spiceprefix=X}
C {devices/lab_pin.sym} 2580 -1140 1 0 {name=l21 sig_type=std_logic lab=mir}
...
C {devices/opin.sym} 1990 -1260 0 0 {name=p3 lab=bg_out}
C {devices/lab_pin.sym} 1940 -1260 0 0 {name=l2 sig_type=std_logic lab=bg_out}
C {devices/ipin.sym} 1610 -1330 2 0 {name=p4 lab=enable}
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 2870 -1260 0 0 {name=M26
L=2
W=3
nf=1
mult=4
...
C {devices/lab_pin.sym} 2810 -1260 2 1 {name=l32 sig_type=std_logic lab=mir}
C {devices/ipin.sym} 2890 -1170 3 0 {name=p6 lab=iref}
C {/foss/designs/Open3LFCC_V2/OTA_erroramp_jm.sym} 2290 -1140 0 0 {name=x1}
C {devices/lab_pin.sym} 2580 -970 1 1 {name=l3 sig_type=std_logic lab=agnd}
C {devices/lab_pin.sym} 2410 -1320 0 1 {name=l5 sig_type=std_logic lab=agnd}
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 3150 -1260 0 0 {name=M7
L=2
W=3
nf=1
mult=4
...
C {devices/lab_pin.sym} 3090 -1260 2 1 {name=l6 sig_type=std_logic lab=mir}
C {devices/lab_pin.sym} 2390 -930 1 1 {name=l9 sig_type=std_logic lab=iref_int}
C {devices/lab_pin.sym} 3170 -1170 1 1 {name=l10 sig_type=std_logic lab=iref_int}
