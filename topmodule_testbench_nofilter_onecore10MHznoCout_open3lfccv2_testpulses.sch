...
.save v(D1) v(D2) v(D1_N) v(D2_N) v(VOUT_CORE) v(vh) i(v3) i(v10) i(v11) v(v_cftop,v_cfbot) v(D1,v_cftop) v(D2,vout_core) v(D2_N,v_cfbot) v(D1_Nv,VSS) v(v_out_ls1) v(v_out_ls2) v(d2_n,v_cfbot) v(D1_s) v(D2_s) v(D2_N_s) v(D1_N_s) v(V_res) i(v9) v(D1_) v(D2_) v(D3_) v(D4_)
...
wrdata /foss/designs/Open3LFCC_V2/3LFCC_v1p5_topmodule_nofil_tp_onecore10MHz_open3lfccv2.txt tran.v(vout_core) tran.i(v3) tran.i(v4) tran.i(v9)
...
plot v(D4_) v(D3_)+2 v(D2_)+4 v(D1_)+6
...
C {devices/lab_wire.sym} 1040 -800 0 1 {name=l29 sig_type=std_logic lab=VOUT_CORE}
...
C {devices/lab_wire.sym} -870 -1330 0 1 {name=l2 sig_type=std_logic lab=D1_}
C {devices/vsource.sym} -880 -1110 0 0 {name=V1 value="PULSE(0 1.8 52.0n 1n 1n 30.0n 100.0n)"}
C {devices/vsource.sym} -880 -1200 0 0 {name=V5 value="PULSE(0 1.8 50.0n 1n 1n 34.0n 100.0n)"}
C {devices/lab_wire.sym} -870 -1240 0 1 {name=l3 sig_type=std_logic lab=D2_}
C {devices/lab_pin.sym} -870 -1150 0 1 {name=l32 sig_type=std_logic lab=D3_
}
C {devices/vsource.sym} -880 -1020 0 0 {name=V6 value="PULSE(0 1.8 2.0n 1n 1n 30.0n 100.0n)"}
C {devices/lab_pin.sym} -870 -1060 0 1 {name=l37 sig_type=std_logic lab=D4_
}
C {devices/lab_wire.sym} -890 -980 0 0 {name=l38 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} -890 -1250 0 0 {name=l40 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} -890 -1160 0 0 {name=l41 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} -890 -1070 0 0 {name=l42 sig_type=std_logic lab=VSS}
C {devices/vsource.sym} -880 -1290 0 0 {name=V7 value="PULSE(0 1.8 0n 1n 1n 34.0n 100.0n)"}
