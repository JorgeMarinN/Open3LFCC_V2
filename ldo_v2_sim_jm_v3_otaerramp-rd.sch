...
lab=vb2}
N 3630 -3520 3630 -3500 {
lab=vb}
N 3630 -3440 3630 -3420 { lab=GND}
N 4000 -3380 4000 -3360 {
lab=vb2}
N 4000 -3300 4000 -3280 { lab=GND}
...
C {devices/lab_pin.sym} 4010 -3470 0 0 {name=l15 sig_type=std_logic lab=vb2}
C {/foss/designs/Open3LFCC_V2/bgr_otard.sym} 2150 -2100 0 0 {name=xb1}
C {devices/lab_pin.sym} 3630 -3520 2 0 {name=l16 sig_type=std_logic lab=vb}
C {devices/isource.sym} 3630 -3470 2 0 {name=I0 value=7u}
C {devices/gnd.sym} 3630 -3420 0 0 {name=l17 lab=GND}
C {devices/lab_pin.sym} 4000 -3380 2 0 {name=l18 sig_type=std_logic lab=vb2}
C {devices/isource.sym} 4000 -3330 2 0 {name=I1 value=7u}
C {devices/gnd.sym} 4000 -3280 0 0 {name=l19 lab=GND}
