...
N 3710 -3570 3710 -3540 { lab=GND}
N 3700 -3330 3740 -3330 { lab=vb}
N 3700 -3380 3700 -3330 { lab=vb}
N 3700 -3380 3780 -3380 { lab=vb}
N 3780 -3300 3780 -3280 { lab=GND}
N 3780 -3330 3860 -3330 { lab=GND}
N 3860 -3330 3860 -3290 { lab=GND}
N 3780 -3290 3860 -3290 { lab=GND}
N 3780 -3380 3780 -3360 { lab=vb}
N 3780 -3430 3780 -3380 { lab=vb}
N 3780 -3280 3780 -3210 { lab=GND}
...
device=resistor
m=1}
C {devices/lab_pin.sym} 3620 -3780 2 0 {name=l12 sig_type=std_logic lab=bg_out}
...
C {devices/lab_pin.sym} 4010 -3470 0 0 {name=l15 sig_type=std_logic lab=vb_n}
C {devices/vsource.sym} 3710 -3600 0 0 {name=Ven1 value=1.2}
C {devices/gnd.sym} 3710 -3540 0 0 {name=l17 lab=GND}
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 3760 -3330 0 0 {name=M20
L=1
W=1
nf=1
mult=4
...
C {devices/gnd.sym} 3780 -3210 0 0 {name=l16 lab=GND}
C {devices/lab_pin.sym} 3780 -3430 2 0 {name=l14 sig_type=std_logic lab=vb}
