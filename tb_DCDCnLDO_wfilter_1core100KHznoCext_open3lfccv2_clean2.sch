...
N 380 -560 380 -530 {
lab=V_CFBOT}
N 460 -1710 460 -1600 { lab=VOUT_CORE}
N 460 -1710 880 -1710 { lab=VOUT_CORE}
N 1180 -1510 1180 -1490 { lab=ldo_out}
N 1180 -1650 1180 -1570 { lab=VOUT_CORE}
N 1180 -1540 1280 -1540 { lab=VOUT_CORE}
N 1280 -1650 1280 -1540 { lab=VOUT_CORE}
N 1100 -1330 1180 -1330 { lab=pos}
N 1180 -1500 1280 -1500 { lab=ldo_out}
N 1280 -1500 1320 -1500 { lab=ldo_out}
N 1180 -1730 1180 -1650 { lab=VOUT_CORE}
N 1280 -1730 1280 -1650 { lab=VOUT_CORE}
N 1180 -1730 1280 -1730 { lab=VOUT_CORE}
N 1180 -1210 1180 -1170 { lab=GND}
N 1180 -1170 1180 -1160 { lab=GND}
N 880 -1710 1180 -1710 { lab=VOUT_CORE}
N 1040 -1540 1140 -1540 { lab=#net3}
N 460 -1450 460 -1430 { lab=GND}
N 360 -1530 390 -1530 { lab=en}
N 1180 -1410 1180 -1300 {
lab=pos}
N 1180 -1240 1180 -1210 {
lab=GND}
N 1180 -1490 1180 -1470 {
lab=ldo_out}
N 540 -1560 570 -1560 {
lab=neg}
N 540 -1500 570 -1500 {
lab=vb}
N 1040 -1540 1040 -1470 {
lab=#net3}
N 660 -1510 700 -1510 {
lab=pos}
N 660 -1430 700 -1430 {
...
.save v(D1) v(D2) v(D1_N) v(D2_N) v(VOUT_CORE) v(ldo_out) v(vh) i(v3) i(v10) i(v11) v(v_cftop,v_cfbot) v(D1,v_cftop) v(D2,vout_core) v(D2_N,v_cfbot) v(D1_Nv,VSS) v(v_out_ls1) v(v_out_ls2) v(d2_n,v_cfbot) v(D1_s) v(D2_s) v(D2_N_s) v(D1_N_s) v(V_res) i(v9) v(en) v(neg)
...
C {devices/lab_pin.sym} 250 -1430 0 0 {name=l46 sig_type=std_logic lab=en}
C {devices/gnd.sym} 250 -1320 0 0 {name=l48 lab=GND}
...
C {bgr2.sym} -900 120 0 0 {name=xb2}
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 1160 -1540 0 0 {name=M1
L=0.5
W=10
nf=1
mult=800
...
C {devices/lab_pin.sym} 1100 -1330 1 0 {name=l58 sig_type=std_logic lab=pos}
C {devices/gnd.sym} 1180 -1160 0 0 {name=l59 lab=GND}
C {devices/opin.sym} 1320 -1500 0 0 {name=p4 lab=ldo_out
}
C {devices/gnd.sym} 980 -1650 0 0 {name=l60 lab=GND}
C {devices/gnd.sym} 460 -1430 0 0 {name=l61 lab=GND}
C {devices/lab_pin.sym} 360 -1530 0 0 {name=l62 sig_type=std_logic lab=en}
C {devices/res.sym} 1180 -1440 0 0 {name=RD3
value=60e3
footprint=1206
device=resistor
m=1}
C {devices/res.sym} 1180 -1270 0 0 {name=RD4
value=40e3
footprint=1206
device=resistor
m=1}
C {devices/lab_pin.sym} 570 -1560 2 0 {name=l64 sig_type=std_logic lab=neg}
C {devices/lab_pin.sym} 570 -1500 2 0 {name=l65 sig_type=std_logic lab=vb}
C {/foss/designs/Open3LFCC_V2/OTA_erroramp_jm.sym} 860 -1470 0 0 {name=x6}
C {devices/lab_pin.sym} 660 -1510 0 0 {name=l66 sig_type=std_logic lab=pos}
C {devices/lab_pin.sym} 660 -1430 0 0 {name=l67 sig_type=std_logic lab=neg}
C {devices/lab_pin.sym} 960 -1250 0 0 {name=l68 sig_type=std_logic lab=vb}
C {devices/lab_wire.sym} 470 -1710 0 1 {name=l63 sig_type=std_logic lab=VOUT_CORE}
C {devices/vsource.sym} 250 -1380 0 0 {name=Ven value="PULSE(0 3.5 50u 1n 1n 0u 500u)"}
