...
lab=vb}
N 3620 -3350 3620 -3310 { lab=GND}
N 3620 -3430 3620 -3410 { lab=#net6}
...
C {/foss/designs/Open3LFCC_V2/bgr_cascode.sym} 2150 -2100 0 0 {name=xb2}
C {devices/vsource.sym} 3620 -3380 0 0 {name=Vs2 value=1.2}
C {devices/gnd.sym} 3620 -3310 0 0 {name=l14 lab=GND}
C {devices/lab_pin.sym} 3710 -3650 2 1 {name=l16 sig_type=std_logic lab=neg}
