...
N 2790 -120 2790 -60 {
lab=#net5}
N 2650 -230 2650 -210 { lab=ldo_out}
N 2650 -370 2650 -290 { lab=VOUT_CORE}
N 2650 -260 2750 -260 { lab=VOUT_CORE}
N 2570 -50 2650 -50 { lab=pos}
N 2650 -450 2650 -370 { lab=VOUT_CORE}
N 2490 -50 2570 -50 { lab=pos}
N 2750 -300 2750 -260 {
lab=VOUT_CORE}
N 2650 -300 2750 -300 {
lab=VOUT_CORE}
...
C {devices/res.sym} 2790 -30 0 0 {name=RL
value=\{RL\}
footprint=1206
device=resistor
m=1}
C {devices/vsource.sym} 2790 -150 0 0 {name=V1 value=0}
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 2630 -260 0 0 {name=M24
L=0.5
W=10
nf=1
mult=800
...
C {devices/gnd.sym} 2790 40 0 0 {name=l52 lab=GND}
C {devices/lab_pin.sym} 2510 -260 0 0 {name=l53 sig_type=std_logic lab=out}
C {devices/lab_pin.sym} 2490 -50 0 0 {name=p3 sig_type=std_logic lab=pos

}
C {devices/lab_pin.sym} 2820 -220 2 0 {name=p1 sig_type=std_logic lab=ldo_out

}
C {devices/lab_wire.sym} 2650 -450 3 1 {name=l54 sig_type=std_logic lab=VOUT_CORE}
C {devices/gnd.sym} 2650 140 0 0 {name=l55 lab=GND}
C {devices/res.sym} 2650 -140 0 0 {name=RD2
value=6.3e3
footprint=1206
device=resistor
m=1}
C {devices/res.sym} 2650 30 0 0 {name=RD1
value=3.7e3
footprint=1206
device=resistor
m=1}
