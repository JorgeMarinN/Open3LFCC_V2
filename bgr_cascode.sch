...
N 3490 -1150 3520 -1150 { lab=bg_out}
N 3470 -1150 3490 -1150 { lab=bg_out}
N 3710 -1330 3710 -1310 { lab=avdd}
N 3710 -1280 3740 -1280 { lab=avdd}
N 3740 -1320 3740 -1280 { lab=avdd}
N 3710 -1320 3740 -1320 { lab=avdd}
N 3630 -1280 3670 -1280 { lab=mir}
N 2360 -1370 2810 -1370 { lab=avdd}
N 3710 -1250 3710 -1190 { lab=iref}
N 2880 -1190 3090 -1190 { lab=agnd}
N 3090 -1240 3090 -1220 { lab=v_cas}
N 3090 -1370 3090 -1300 { lab=avdd}
N 2810 -1370 3090 -1370 { lab=avdd}
N 2880 -1370 2880 -1300 { lab=avdd}
N 3040 -1030 3040 -940 { lab=agnd}
N 2950 -1190 2950 -940 { lab=agnd}
N 2780 -1270 2880 -1270 { lab=avdd}
N 2780 -1370 2780 -1270 { lab=avdd}
N 3090 -1270 3200 -1270 { lab=avdd}
N 3200 -1370 3200 -1270 { lab=avdd}
N 3080 -1370 3200 -1370 { lab=avdd}
N 3040 -1060 3120 -1060 { lab=agnd}
N 3120 -1060 3120 -940 { lab=agnd}
N 2950 -940 3040 -940 { lab=agnd}
N 3040 -940 3120 -940 { lab=agnd}
N 2820 -1190 2840 -1190 { lab=inp}
N 3130 -1190 3160 -1190 { lab=N}
N 2730 -1370 2780 -1370 { lab=avdd}
N 2780 -1370 2810 -1370 { lab=avdd}
N 2860 -940 2950 -940 { lab=agnd}
N 2680 -1370 2680 -1230 { lab=avdd}
N 2680 -1200 2740 -1200 { lab=avdd}
N 2740 -1370 2740 -1200 { lab=avdd}
N 2610 -1200 2640 -1200 { lab=mir}
N 2680 -1050 2680 -940 { lab=agnd}
N 2630 -1080 2630 -940 { lab=agnd}
N 3090 -1230 3170 -1230 { lab=v_cas}
N 2880 -1160 2880 -1120 { lab=#net11}
N 2880 -1240 2880 -1220 { lab=#net12}
N 2920 -1270 3050 -1270 { lab=#net12}
N 2990 -1270 2990 -1230 { lab=#net12}
N 2880 -1230 2990 -1230 { lab=#net12}
N 3090 -1160 3090 -1120 { lab=#net11}
N 2880 -1120 3090 -1120 { lab=#net11}
N 3040 -1120 3040 -1090 { lab=#net11}
N 2680 -1170 2680 -1110 { lab=#net13}
N 2720 -1080 2770 -1080 { lab=#net13}
N 2770 -1120 2770 -1080 { lab=#net13}
N 2680 -1120 2770 -1120 { lab=#net13}
N 2770 -1060 3000 -1060 { lab=#net13}
N 2770 -1080 2770 -1060 { lab=#net13}
N 2630 -1080 2680 -1080 { lab=agnd}
N 3240 -1230 3250 -1230 { lab=v_cas}
N 3170 -1230 3240 -1230 { lab=v_cas}
N 3250 -1230 3270 -1230 { lab=v_cas}
N 3260 -1230 3260 -1160 { lab=v_cas}
N 3260 -1100 3260 -940 { lab=agnd}
N 3120 -940 3260 -940 { lab=agnd}
N 2420 -940 2870 -940 {
lab=agnd}
N 3200 -1370 3710 -1370 {
lab=avdd}
N 3710 -1370 3710 -1330 {
lab=avdd}
N 640 -1250 640 -1230 {
lab=N}
N 640 -1170 640 -1150 {
...
C {devices/opin.sym} 3520 -1150 0 0 {name=p3 lab=bg_out}
C {devices/lab_pin.sym} 3470 -1150 0 0 {name=l2 sig_type=std_logic lab=bg_out}
C {devices/ipin.sym} 1610 -1330 2 0 {name=p4 lab=enable}
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 3690 -1280 0 0 {name=M26
L=2
W=3
nf=1
mult=4
...
C {devices/lab_pin.sym} 3630 -1280 2 1 {name=l32 sig_type=std_logic lab=mir}
C {devices/ipin.sym} 3710 -1190 2 0 {name=p6 lab=iref}
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 2900 -1270 0 1 {name=M9
L=2
W=3
nf=1
mult=4
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 2860 -1190 0 0 {name=M10
L=1
W=3
nf=1
mult=8
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 3110 -1190 0 1 {name=M11
L=1
W=3
nf=1
mult=8
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 3070 -1270 0 0 {name=M13
L=2
W=3
nf=1
mult=4
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 3020 -1060 0 0 {name=M14
L=2
W=5
nf=1
mult=4
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 2660 -1200 0 0 {name=M17
L=2
W=3
nf=1
mult=8
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 2700 -1080 0 1 {name=M18
L=2
W=5
nf=1
mult=4
...
C {devices/lab_pin.sym} 2610 -1200 0 0 {name=l3 sig_type=std_logic lab=mir}
C {devices/lab_pin.sym} 2820 -1190 0 0 {name=l6 sig_type=std_logic lab=inp}
C {sky130_fd_pr/cap_mim_m3_1.sym} 3260 -1130 0 0 {name=C2 model=cap_mim_m3_1 W=16 L=16 MF=1 spiceprefix=X}
C {devices/lab_pin.sym} 3220 -1230 1 0 {name=l9 sig_type=std_logic lab=v_cas}
C {devices/lab_pin.sym} 3160 -1190 0 1 {name=l5 sig_type=std_logic lab=N}
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 660 -1200 0 1 {name=M8
L=2
W=3
nf=1
mult=8
...
C {devices/lab_pin.sym} 640 -1240 0 1 {name=l10 sig_type=std_logic lab=N}
C {devices/lab_pin.sym} 730 -1200 2 0 {name=l12 sig_type=std_logic lab=v_cas}
